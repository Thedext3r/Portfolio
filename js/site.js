...
const NAV_HTML = `
  <nav id="nav">
    <div class="nav-side">
      ...
      <span class="nav-loc">GURUGRAM,&nbsp;INDIA</span>
    </div>
    ...
    <div class="nav-side right">
      <button class="sound-toggle-btn" type="button" aria-label="Toggle subtle UI sound effects" aria-pressed="false" data-cursor="hover-link" style="margin-right: 6px;">
        <svg class="sound-icon-svg" viewBox="0 0 24 24"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/></svg>
        <span class="sound-toggle-label">Sound Off</span>
      </button>
...
const FOOTER_HTML = `
  <footer class="footer" id="contact">
    ...
    <div class="ft-inner">
      <p class="ft-sub reveal">From user-centered UI/UX design to strategic digital marketing campaigns, I help brands and teams build intuitive products that drive real engagement.</p>
      <h2 class="ft-head"><button class="ft-head-btn" type="button" data-contact-open>Let’s connect & collaborate</button></h2>
    </div>

    <p class="ft-credit">Designed by Sunil Ohdar · Gurugram, India @2026</p>
    <nav class="ft-social" aria-label="Social links">
      <a href="https://www.linkedin.com/in/sunilohdar" target="_blank" rel="noopener">LinkedIn</a>
      <a href="mailto:sunilohdar02@gmail.com" rel="noopener">Email</a>
      <a href="tel:+918340741049" rel="noopener">Phone</a>
    </nav>
  </footer>
`;

const CONTACT_EMAIL = 'sunilohdar02@gmail.com';
...
const CONTACT_HTML = `
  ...
  <aside class="contact-drawer" id="contact-drawer" role="dialog" aria-modal="true" aria-labelledby="cd-title">
    ...
    <div class="cd-body">
      <p class="cd-eyebrow"><span class="cd-dot" aria-hidden="true"></span>AVAILABLE FOR OPPORTUNITIES & PROJECTS</p>
      <h2 class="cd-title" id="cd-title">Let’s connect</h2>
      <p class="cd-intro">Looking for UI/UX Design, Digital Marketing, or internship opportunities. Feel free to reach out directly!</p>
      ...
      <form class="cd-form" id="cd-form">
        ...
        <div class="cd-fields">
          <div class="cd-field">
            ...
            <input class="cd-input" id="cd-name" name="name" type="text" required placeholder="Your Name" autocomplete="name">
          </div>
          <div class="cd-field">
          ...
          <div class="cd-field">
            <label class="cd-label" for="cd-msg">MESSAGE</label>
            <textarea class="cd-input cd-textarea" id="cd-msg" name="message" rows="3" required placeholder="A few lines about your project, role, or inquiry"></textarea>
          </div>
        </div>
        <button class="cd-send" type="submit">
          <span class="cd-send-label">Send Message</span>
      ...
      <div class="cd-done" hidden>
        ${daisySVG()}
        <h3 class="cd-done-title">Message Sent!</h3>
        <p class="cd-done-copy">Thank you for reaching out. I'll get back to you promptly.</p>
      </div>
    </div>
    ...
    <div class="cd-alt">
      ...
      <p class="cd-alt-label">DIRECT CONTACT</p>
      <a class="cd-alt-mail" href="mailto:${CONTACT_EMAIL}" style="display:inline-flex; align-items:center; gap:6px;"><img src="/assets/imgEmail.svg" alt="" width="16" height="16" style="filter: brightness(0) invert(1);">${CONTACT_EMAIL}</a>
      <p style="margin: 4px 0 12px; font-size: 13px; color: rgba(255,255,255,0.85); font-family: 'JetBrains Mono', monospace;">+91 8340741049 · DLF Phase 3, Gurugram</p>
      <nav class="cd-alt-social" aria-label="Social links">
        <a href="https://www.linkedin.com/in/sunilohdar" target="_blank" rel="noopener">LinkedIn&nbsp;↗</a>
        <a href="mailto:${CONTACT_EMAIL}">Email&nbsp;↗</a>
        <a href="tel:+918340741049">Phone&nbsp;↗</a>
      </nav>
    </div>
  </aside>
`;
...
function initGarden() {
      ...
      footer.addEventListener('pointerleave', () => { footer.classList.remove('garden-live'); if (cursor) cursor.classList.remove('on'); if (tip) tip.classList.remove('on'); });
